...
import type { AddrStr, Amount, AmountOf, AssetInfo, AssetRestriction, AssetRestrictions, AssetType, BtcDepositCache, BtcHeader, BtcHeaderIndex, BtcNetwork, BtcPartialMerkleTree, BtcRelayedTxInfo, BtcTransaction, BtcTrusteeAddrInfo, BtcTrusteeIntentionProps, BtcTrusteeSessionInfo, BtcTrusteeType, BtcTxResult, BtcTxState, BtcTxType, BtcTxVerifier, BtcVoteResult, BtcWithdrawalProposal, Chain, ChainAddress, CurrencyId, CurrencyPair, Decimals, Depth, Desc, FullPairInfo, GenericTrusteeIntentionProps, GenericTrusteeSessionInfo, Handicap, HandicapInfo, Memo, MiningAssetInfo, MiningWeight, NetworkType, NominatorLedger, OrderExecutedInfo, OrderId, OrderInfo, OrderProperty, OrderType, Page, Price, PriceFluctuation, ReferralId, RpcBalance, RpcFeeDetails, RpcInclusionFee, RpcMiningDividendInfo, RpcMiningWeight, RpcOrder, RpcPrice, RpcTotalAssetInfo, RpcVoteWeight, RpcWithdrawalRecord, Side, String, Token, TotalAssetInfo, TradingHistoryIndex, TradingPairId, TradingPairProfile, TrusteeInfoConfig, Unbonded, ValidatorInfo, WithdrawalLimit, WithdrawalRecord, WithdrawalRecordId, WithdrawalRecordOf, WithdrawalState } from '@chainx/xbridge-types/chainx';
import type { BlockNumberFor, BtcAddress, CurrencyIdOf, ErrorCode, IssueRequest, PerDispatchClass, RedeemRequest, RequestId, RpcVaultInfo, Status, TradingPrice, Vault, VaultStatus } from '@chainx/xbridge-types/xGatewayBitcoinV2';
